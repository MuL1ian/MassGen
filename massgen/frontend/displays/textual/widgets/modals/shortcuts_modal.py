            ...
            with Horizontal(id="shortcuts_columns"):
                ...
                with Container(id="shortcuts_col_right", classes="shortcuts-column"):
                    yield Static(
                        ...
                        "\n"
                        "[bold cyan]Mode Bar[/]\n"
                        "  [yellow]Plan[/]          Planning workflow mode\n"
                        "  [yellow]Multi-Agent[/]   Use all agents vs one selected\n"
                        "  [yellow]Parallel[/]      Same task + voting (default)\n"
                        "  [yellow]Decomposition[/] Independent subtasks per agent\n"
                        "  [yellow]Subtasks[/]      Set per-agent subtasks\n"
                        "  [yellow]Refine[/]        Iterative voting/refinement\n"
                        "  [yellow]⋮[/]             Plan options and selector\n"
                        "  [yellow]?[/]             Open this mode guide\n"
                        "  [yellow]Override[/]      Manual winner selection (when available)\n"
                        "\n"
                        "[bold cyan]Quit[/]\n"
